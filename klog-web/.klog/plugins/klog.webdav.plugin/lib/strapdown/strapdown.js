...
(function(window, document) {
    ...
    //
    var markdownEl = document.getElementsByTagName("xmp")[0] || document.getElementsByTagName("textarea")[0], titleEl = document.getElementsByTagName("title")[0], scriptEls = document.getElementsByTagName("script"), navbarEl = document.getElementsByClassName("navbar")[0];
    //////////////////////////////////////////////////////////////////////
    //
    // <head> stuff
    //
    ...
    if (document.head.firstChild) document.head.insertBefore(metaEl, document.head.firstChild); else document.head.appendChild(metaEl);
    ...
    var themes = ["amelia","cerulean","cyborg","journal","readable","simplex","slate","spacelab","spruce","superhero","united"]
		/*
